...
public class Comparacion{    
	...
	public static void main(String[] args) {
	 /* bloquear recibe los siguientes parametros (la lista de palabras que se van a bloquear, la palabra recibida,
	 * la palabra con lo que se va a bloquear, el rango de diferencias)*/
		boolean bloqueado = bloquear("ListaNoPermitidos.txt", "regueton", "Reggaeton", 2);
